...
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/animation_config.py scaffold <project>

# Validate references before export
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/animation_config.py validate <project>

# Export reads <project>/animations.json automatically when present
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_to_pptx.py <project>
```
...
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_to_pptx.py <project> -t push --transition-duration 0.6

# Disable
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_to_pptx.py <project> -t none

# Auto-advance every 5 seconds (kiosk-style playback)
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_to_pptx.py <project> --auto-advance 5
```
...
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_to_pptx.py <project> -a none

# Use a single effect (still cascades via the default after-previous trigger)
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_to_pptx.py <project> --animation fade

# Switch to on-click for live presentations (presenter controls pacing)
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_to_pptx.py <project> --animation-trigger on-click

# Custom pacing
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_to_pptx.py <project> --animation mixed \
        --animation-stagger 0.7 --animation-duration 0.5

# All groups animate in unison on slide entry
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_to_pptx.py <project> --animation-trigger with-previous
```
