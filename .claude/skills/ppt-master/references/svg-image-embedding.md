...
4. Preview: ${SKILL_DIR}/.venv/bin/python -m http.server -d <project_path> 8000 → /svg_output/<filename>.svg
...
```bash
${SKILL_DIR}/.venv/bin/python -m http.server -d <project_path> 8000
...
```bash
${SKILL_DIR}/.venv/bin/python scripts/svg_finalize/embed_images.py <svg_file>                         # Single file
${SKILL_DIR}/.venv/bin/python scripts/svg_finalize/embed_images.py <project_path>/svg_output/*.svg    # Batch
${SKILL_DIR}/.venv/bin/python scripts/svg_finalize/embed_images.py --dry-run <project_path>/svg_output/*.svg  # Preview
```
