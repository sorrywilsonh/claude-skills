...
```bash
${SKILL_DIR}/.venv/bin/python scripts/notes_to_audio.py <project_path> --voice zh-CN-XiaoxiaoNeural
${SKILL_DIR}/.venv/bin/python scripts/svg_to_pptx.py <project_path> --recorded-narration audio
```
