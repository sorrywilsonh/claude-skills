...
```bash
${SKILL_DIR}/.venv/bin/python scripts/analyze_images.py <project_path>/images                    # Default: PPT 16:9
${SKILL_DIR}/.venv/bin/python scripts/analyze_images.py <project_path>/images --canvas ppt43     # PPT 4:3
${SKILL_DIR}/.venv/bin/python scripts/analyze_images.py <project_path>/images --canvas xiaohongshu  # Xiaohongshu
```
