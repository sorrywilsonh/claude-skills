...
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/latex_render.py <project_path>
```
...
**When selection includes B**, you must run `${SKILL_DIR}/.venv/bin/python scripts/analyze_images.py <project_path>/images` before outputting the spec, and integrate scan results into the image resource list.
...
```bash
${SKILL_DIR}/.venv/bin/python scripts/project_manager.py init <project_name> --format <canvas_format>
```
