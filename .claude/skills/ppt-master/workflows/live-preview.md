...
```bash
${SKILL_DIR}/.venv/bin/python ${SKILL_DIR}/scripts/svg_editor/server.py <project_path>
```
...
1. Discover annotations:
   ```bash
   ${SKILL_DIR}/.venv/bin/python ${SKILL_DIR}/scripts/check_annotations.py <project_path>
   ```
...
```bash
${SKILL_DIR}/.venv/bin/python ${SKILL_DIR}/scripts/svg_editor/server.py <project_path> --no-browser
# or for Step 6's auto-startup on a remote host:
${SKILL_DIR}/.venv/bin/python ${SKILL_DIR}/scripts/svg_editor/server.py <project_path> --live --no-browser
```
