...
- Default mode: `edge-tts` is installed (`${SKILL_DIR}/.venv/bin/python -m pip install edge-tts`).
...
```bash
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/notes_to_audio.py --list-voices --locale <locale>
```

**ElevenLabs backend**:

```bash
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/notes_to_audio.py --provider elevenlabs --list-voices
```

**Cloud providers using explicit voice IDs/names**:

```bash
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/notes_to_audio.py --provider minimax --list-voices
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/notes_to_audio.py --provider qwen --list-voices
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/notes_to_audio.py --provider cosyvoice --list-voices
```
...
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/notes_to_audio.py <project_path> \
...
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_to_pptx.py <project_path> \
...
- (If skipped embedding) one-line hint on how to embed later: `${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_to_pptx.py <project_path> --recorded-narration audio`.
