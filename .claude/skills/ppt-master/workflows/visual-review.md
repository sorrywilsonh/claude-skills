...
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_editor/server.py <project_path> --no-browser
...
```bash
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/visual_review.py <project_path>
```
