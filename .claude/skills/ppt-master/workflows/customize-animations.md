...
```bash
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/animation_config.py list-groups <project_path>
```
...
```bash
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/animation_config.py scaffold <project_path>
```
...
```bash
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/animation_config.py validate <project_path>
```
