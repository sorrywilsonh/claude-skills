...
5. Run the matching calculator command:
   ...
   ${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_position_calculator.py calc bar \
   ...
   ${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_position_calculator.py calc line \
   ...
   ${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_position_calculator.py calc pie \
   ...
   ${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_position_calculator.py calc radar \
...
```bash
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/svg_quality_checker.py <project_path>
```
...
```bash
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/total_md_split.py <project_path>
${SKILL_DIR}/.venv/bin/python skills/ppt-master/scripts/finalize_svg.py <project_path>
